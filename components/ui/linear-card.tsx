          ...
          <React.Fragment key={item.id}>
            ...
            >
              <DialogTrigger
                ...
                className="flex w-full flex-col overflow-hidden border bg-gray-300 hover:bg-gray-200 dark:bg-black dark:hover:bg-gray-950"
              >
                <DialogImage
                  src={item.url.src}
                  alt=""
                ...
                <div className="flex flex-grow flex-row items-end justify-between p-3">
                  ...
                  <button
                    type="button"
                    className="absolute bottom-2 right-2 rounded-full bg-gray-400 p-2 hover:bg-gray-500 dark:bg-gray-900 dark:hover:bg-gray-800"
                  >
              ...
              <DialogContainer className="pt-20">
                <DialogContent
                  ...
                  className="relative mx-auto flex h-full w-[80%] flex-col overflow-y-auto border bg-gray-300 hover:bg-gray-200 dark:bg-black dark:hover:bg-gray-950 lg:w-[900px]"
                >
                  <DialogImage
                    src={item.url.src}
                    alt=""
                  ...
                  <DialogClose className="rounded-full bg-gray-400 p-4 text-zinc-50 hover:bg-gray-500 dark:bg-gray-900 dark:hover:bg-gray-800" />
                </DialogContent>
              </DialogContainer>
            </Dialog>
          </React.Fragment>
